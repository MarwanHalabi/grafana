...
An active decision to include a change in the changelog needs to be taken for every pull request. Indicate your decision by adding or removing labels on the pull request or by updating the pull request title or description.
...
Not complying with the above rules may result in your change being excluded or flagged during release preparation.
